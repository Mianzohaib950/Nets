...
import waterparkNewConstructionObstacleCourse from "../../imports/waterpark-new-construction-obstacle-course.webp";
import waterparkRedesignPoolRopeHandrail from "../../imports/waterpark-redesign-pool-rope-handrail.webp";
import waterparkDryPlayRopeCourse from "../../imports/waterpark-dry-play-rope-course.webp";

export default function Waterpark() {
  return (
    <ApplicationPage
      pageTitle="We Waterpark"
      heroImage={waterparkHeroWaterslidePool}
      ...
      subsections={[
        {
          ...
          image: waterparkNewConstructionObstacleCourse,
        },
        {
          ...
          image: waterparkRedesignPoolRopeHandrail,
        },
        {
          title: "Dry Play",
          ...
          image: waterparkDryPlayRopeCourse,
        },
      ]}
